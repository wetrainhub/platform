...
{
    public abstract class EfCoreCompanyEmailRepositoryBase : EfCoreRepository<CrmDbContext, CompanyEmail, Guid>
    {
        public EfCoreCompanyEmailRepositoryBase(IDbContextProvider<CrmDbContext> dbContextProvider)
            : base(dbContextProvider)
        {

        }

        public virtual async Task<List<CompanyEmail>> GetListByCompanyIdAsync(
           Guid companyId,
           string? sorting = null,
           ...
           CancellationToken cancellationToken = default)
        {
            ...
            query = query.OrderBy(string.IsNullOrWhiteSpace(sorting) ? CompanyEmailConsts.GetDefaultSorting(false) : sorting);
        ...
        public virtual async Task<List<CompanyEmail>> GetListAsync(
        ...
        protected virtual IQueryable<CompanyEmail> ApplyFilter(
            IQueryable<CompanyEmail> query,
            string? filterText = null,
            string? value = null,
            CompanyEmailType? type = null)
        {
