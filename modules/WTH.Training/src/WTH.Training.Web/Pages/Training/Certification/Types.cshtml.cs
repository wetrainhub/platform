...
public class TypesModel(IThemePageLayout themePageLayout) : TrainingPageModel
{
    public void OnGet()
    {
        ...
        var breadcrumb = new List<BreadCrumbItem>()
        {
            ...
            new BreadCrumbItem("Types")
        };
        themePageLayout.Content.SetTitleWithBreadCrumb("Types",breadcrumb);
    }
}
