...
namespace WTH.Platform.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("Platform") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "Platform", DisplayName = "Platform API", Resources = { "Platform" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        var consoleAndAngularClientId = configurationSection["Platform_App:ClientId"];
        if (!consoleAndAngularClientId.IsNullOrWhiteSpace())
        {
            var consoleAndAngularClientRootUrl = configurationSection["Platform_App:RootUrl"]?.TrimEnd('/');
        ...
        //MAUI Client
        var mauiClientId = configurationSection["Platform_Maui:ClientId"];
        if (!mauiClientId.IsNullOrWhiteSpace())
        {
            var mauiClientRootUrl = configurationSection["Platform_Maui:RootUrl"]?.Replace("_", "-");
            var mauiClientPostLogoutRedirectUri = configurationSection["Platform_Maui:PostLogoutRedirectUri"]?.Replace("_", "-");
            await CreateApplicationAsync(
                name: mauiClientId!,
                type: OpenIddictConstants.ClientTypes.Public,
                consentType: OpenIddictConstants.ConsentTypes.Implicit,
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["Platform_Swagger:ClientId"];
        ...
        // Web Public Client
        var webPublicClientId = configurationSection["Platform_Web_Public:ClientId"];
        if (!webPublicClientId.IsNullOrWhiteSpace())
        {
            var webPublicRootUrl = configurationSection["Platform_Web_Public:RootUrl"]!.EnsureEndsWith('/');
            ...
            await CreateApplicationAsync(
                ...
                secret: configurationSection["Platform_Web_Public:ClientSecret"] ?? "1q2w3e*",
