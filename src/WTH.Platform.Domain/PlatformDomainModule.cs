...
[DependsOn(
    ...
    [DependsOn(typeof(TrainingDomainModule))]
        ...
        Configure<NewsletterOptions>(options =>
        {
            options.AddPreference(
                ...
                new NewsletterPreferenceDefinition(
                    LocalizableString.Create<PlatformResource>("NewsletterPreference_Default"),
                    privacyPolicyConfirmation: LocalizableString.Create<PlatformResource>("NewsletterPrivacyAcceptMessage")
                )
            );
        });
