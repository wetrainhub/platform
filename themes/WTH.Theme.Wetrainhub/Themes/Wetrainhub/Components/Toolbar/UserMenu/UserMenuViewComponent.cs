...
namespace WTH.Theme.Wetrainhub.Themes.Wetrainhub.Components.Toolbar.UserMenu;
...
public class UserMenuViewComponent : AbpViewComponent
{
    ...
    public virtual async Task<IViewComponentResult> InvokeAsync()
    {
        ...
        return View("~/Themes/Wetrainhub/Components/Toolbar/UserMenu/Default.cshtml", menu);
    }
}
